      ...
      <div className="relative w-full max-w-6xl">
        {enviado ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="bg-white/90 backdrop-blur-sm p-12 md:p-16 rounded-[2rem] shadow-2xl border border-white/50">
              ...
              <form onSubmit={handleSubmit} className="space-y-10">
                ...
                <div className="text-center pt-8">
                  ...
                  >
                    <span className="relative z-10 ">Consultanos</span>
            ...
            {/* Mapa */}
            <div className="bg-white/90 backdrop-blur-sm rounded-[2rem] shadow-2xl border border-white/50 overflow-hidden">
              <div className="p-8">
                <h3 className="text-2xl font-serif font-light text-gray-800 mb-2 tracking-wide">
                  Nuestra ubicación
                </h3>
                <p className="text-gray-600 mb-6">
                  Visítenos en nuestras oficinas en el corazón de Madrid
                </p>
              </div>
              <div className="h-96">
                <SimpleMap />
