...
>
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute bottom-1/3 left-1/2 w-1 h-1 bg-amber-400 rounded-full animate-pulse" style={{ animationDelay: '1s' }}></div>
        ...
        <div className="absolute bottom-1/4 left-1/3 w-1 h-1 bg-amber-300 rounded-full animate-pulse" style={{ animationDelay: '2s' }}></div>
      </div>
      ...
      <motion.div 
        ...
        className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-gradient-radial from-amber-400/20 via-amber-600/10 to-transparent rounded-full blur-3xl"
      ></motion.div>
      ...
      <div className="relative max-w-5xl mx-auto text-center">
        ...
        <motion.div
          ...
          className="h-0.5 bg-gradient-to-r from-transparent via-amber-400 to-transparent mx-auto mb-12"
        ></motion.div>
        ...
        <motion.div
          ...
          className="mb-16"
        >
          <p className="text-amber-300 text-sm md:text-base font-light tracking-[0.3em] uppercase mb-6 opacity-90">
        ...
        >
          <p className="text-white/90 text-xl md:text-2xl leading-relaxed font-light mb-8 tracking-wide">
            ...
            <span className="text-amber-300 font-medium"> Por eso cada detalle importa.</span>
          </p>
          ...
          <motion.div 
            ...
            className="text-amber-200 text-lg md:text-xl font-light italic leading-relaxed"
          >
        ...
        <motion.div
          ...
          className="mb-12"
        >
          <div className="inline-flex items-center justify-center px-12 py-4 border-2 border-amber-400/50 rounded-full bg-gradient-to-r from-amber-900/30 to-amber-800/30 backdrop-blur-sm hover:from-amber-800/40 hover:to-amber-700/40 transition-all duration-500 group cursor-pointer">
            <span className="text-amber-300 font-medium text-lg tracking-wide group-hover:text-amber-200 transition-colors duration-300">
        ...
        >
          <div className="flex items-center space-x-2">
            ...
            <div className="w-16 h-px bg-gradient-to-r from-amber-400/60 to-transparent"></div>
          </div>
          
          <motion.div 
            animate={{ rotate: 360 }}
            transition={{ duration: 20, repeat: Infinity, ease: "linear" }}
            className="w-6 h-6 border border-amber-400/60 rotate-45 relative"
          >
            <div className="absolute inset-1 bg-amber-400/20 rotate-45"></div>
          </motion.div>
          
          <div className="flex items-center space-x-2">
            <div className="w-16 h-px bg-gradient-to-l from-amber-400/60 to-transparent"></div>
            <div className="w-2 h-2 bg-amber-400 rounded-full animate-pulse"></div>
          </div>
        </motion.div>
        ...
        <motion.div
          ...
          className="h-0.5 bg-gradient-to-r from-transparent via-amber-400 to-transparent mx-auto mt-12"
        ></motion.div>
      </div>
      ...
      <motion.div 
        ...
        className="absolute top-0 left-0 w-full h-px bg-gradient-to-r from-transparent via-amber-400/40 to-transparent"
      ></motion.div>
      ...
      <motion.div 
        ...
        className="absolute bottom-0 left-0 w-full h-px bg-gradient-to-r from-transparent via-amber-400/40 to-transparent"
      ></motion.div>
    </motion.section>
  );
};
